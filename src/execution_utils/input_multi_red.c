...
/*   Updated: 2022/11/09 12:53:11 by emlicame         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_token	*get_test_input(void)
{
	...
	node6->token_type = WORD;
	node6->content = ft_substr("-e", 0, 2);
	node7 = malloc(sizeof(t_token));
	node7->token_type = GREAT;
	node7->content = ft_substr(">", 0, 1);
	node8 = malloc(sizeof(t_token));
	node8->token_type = WORD;
	node8->content = ft_substr("outfile", 0, 7);
	// node6 = malloc(sizeof(t_token));

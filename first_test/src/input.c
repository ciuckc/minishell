...
/*   Updated: 2022/10/25 15:19:22 by emlicame         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_token	*get_test_input(void)
{
	...
	node1->token_type = WORD;
	node1->content = ft_substr("./a.out", 0, 7);
	...
	node4->token_type = WORD;
	node4->content = ft_substr("outfile", 0, 7);
